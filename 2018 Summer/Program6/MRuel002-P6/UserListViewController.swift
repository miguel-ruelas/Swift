...
class UserListViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObject(_ sender: Any) {
        ...
        newUser.fname = "Edit First"
        newUser.lname = "Edit Last"
        newUser.id = 0000
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print("Cell for:\(String(describing: user.fname))")
        return cell
    }
    ...
    func configureCell(_ cell: UserListTableViewCell, withEvent user: Users) {
        cell.firstName!.text = user.fname
        cell.lastName!.text = user.lname
        cell.pin!.text = String(user.id)
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        ...
        case .update:
            configureCell(tableView.cellForRow(at: indexPath!)! as! UserListTableViewCell, withEvent: anObject as! Users)
        case .move:
            configureCell(tableView.cellForRow(at: indexPath!)! as! UserListTableViewCell, withEvent: anObject as! Users)
